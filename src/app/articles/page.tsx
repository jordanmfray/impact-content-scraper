...
export default function ArticlesPage() {
  ...
  // Articles for grid section (skip first 4 which are used in spotlight carousel)
  const gridArticles = articles.slice(4, 8)

  return (
    <Box style={{ 
      marginLeft: '310px', // 256px sidebar + 24px sidebar margin + 34px gap = 310
      marginRight: '34px',
      paddingTop: '24px',
      paddingBottom: '24px'
    }}>
      <Flex direction="column" gap="6">
        ...
        {/* Spotlight Carousel */}
        <SpotlightCarousel articles={articles} />
